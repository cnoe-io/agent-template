...
#  Need to fix or delete the following
# f      def petstore_agent(state: AgentState, config: RunnableConfig) -> Dict[str, Any]:
#           return asyncio.run(_async_petstore_agent(state, config))m langchain_mcp_adapters.client import MultiServerMCPClient
...
class PetStoreAgent:
    ...
    def __init__(self):
      ...
      async def _async_petstore_agent(state: AgentState, config: RunnableConfig) -> Dict[str, Any]:
          ...
          server_path = args.get("server_path", "./agent_petstore/protocol_bindings/mcp_server/mcp_petstore/server.py")
      ...
      def _create_agent(state: AgentState, config: RunnableConfig) -> Dict[str, Any]:
          return asyncio.run(_async_petstore_agent(state, config))
      messages = []
